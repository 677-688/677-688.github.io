...
export const teekConfig = defineTeekConfig({
    ...
    notice: {
        ...
        title: "", // 公告标题，支持函数式：需要和国际化搭配使用，根据不同语言环境返回不同标题
        initOpen: true,//第一次进入页面，是否默认打开公告弹框
    ...
    footerInfo: {
        ...
        copyright: {
            ...
            suffix: "677. All Rights Reserved.", // 后缀
        },
        // ICP 备案信息配置
        // icpRecord: {
    ...
    articleBanner: {
        ...
        showTag: true, // 是否展示标签
        defaultCoverImg: "/backgrounds/bg1.png", // 默认封面图
    ...
    //         content: `<img src='/xx.png'>`, // 赞赏内容，支持 HTML
